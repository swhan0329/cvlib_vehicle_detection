...
def rectify_image(image, clip_factor=6, algorithm='independent', 
    ...
    # vis_edgelets(image, edgelets1, True)

    if algorithm == 'independent':
        # Find first vanishing point
        vp1 = ransac_vanishing_point(edgelets1, 5000, threshold_inlier=10)
        if reestimate:
            vp1 = reestimate_model(vp1, edgelets1, 5)
        print("vanishing point1::",vp1[0]/vp1[2], vp1[1]/vp1[2])
        ...
        vp2 = ransac_vanishing_point(edgelets2, 5000, threshold_inlier=10)
        if reestimate:
            vp2 = reestimate_model(vp2, edgelets2, 5)
        print("vanishing point2::",vp2[0]/vp2[2], vp2[1]/vp2[2])
...
if __name__ == '__main__':
    ...
    #     print("moved ", i,"pixesl")
    #     img = ndimage.shift(image, (i, i, 3))
    ...
    #     print("rotated ", i,"angle")
    #     img = ndimage.rotate(image, i, reshape=True)
    #     print("Rectifying {}".format(image_name))
    #     save_name = '.'.join(image_name.split('.')[:-1]) + '_warped.png'
